Added `--tail_free_z` argument, implementing the tail-free sampling algorithm from here https://www.trentonbricken.com/Tail-Free-Sampling/#tail-free-sampling-algorithm
